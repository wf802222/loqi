...
**Loqi** (from *loci* - the Latin root of the [memory palace technique](https://en.wikipedia.org/wiki/Method_of_loci)) is an experimental memory system for AI agents that re-injects the right policies and prior decisions after context loss.
